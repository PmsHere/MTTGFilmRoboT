    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton(
                    "🪄 ᴍᴀɢɪᴄ", url=f"http://t.me/{temp.U_NAME}?startgroup=true"
                ),
            ],
            [
            ...
            [
                InlineKeyboardButton(
                    "❤️‍🔥 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀʟʟᴜ ᴛᴏʀᴇɴᴛᴢ", url="http://t.me/Mallutorentztg"
                ),
            ],
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def advantage_spell_chok(msg):
    ...
    if not g_s:
        k = await msg.reply(
            "<b>I couldn't find anything in than name.\n\n<a href='https://t.me/PmsHereRobot'>Ｄｒ⚕️ ᴀᴅɪᴛʏᴀ</a></b>"
        )
